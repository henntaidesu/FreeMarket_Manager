...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'system/product-type-category-mappings', name: 'ProductTypeCategoryMappings', component: () => import('@/views/system/ProductTypeCategoryMappings/index.vue'), meta: { title: '煤炉类型映射', icon: 'Connection' } },
      { path: 'system/yahoo-category-mappings', name: 'YahooCategoryMappings', component: () => import('@/views/system/YahooCategoryMappings/index.vue'), meta: { title: '雅虎类型映射', icon: 'Connection' } },
